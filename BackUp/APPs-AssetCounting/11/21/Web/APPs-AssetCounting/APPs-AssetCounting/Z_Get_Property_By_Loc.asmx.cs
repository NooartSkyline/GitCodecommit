...
namespace APPs_AssetCounting
{
    ...
    public class Z_Get_Property_By_Loc : System.Web.Services.WebService
    {
        ...
        [WebMethod]
        public string Z_GET_PROPERTY_BY_LOC(string BRANCH, string WERKS, string STORT, string ANLN1)
        {
            ...
            try
            {
                if (BRANCH != "" && WERKS != "") // SiteCode และ Sloc บังคับให้ระบุ
                {
                    ...
                    smartObject.ListMethods["Z_GET_PROPERTYBY_LOC_Z_GET_PROPERTY_BY_LOC"].InputProperties["p_P_ANLN1"].Value = utilities.AddZero(ANLN1, 12);
