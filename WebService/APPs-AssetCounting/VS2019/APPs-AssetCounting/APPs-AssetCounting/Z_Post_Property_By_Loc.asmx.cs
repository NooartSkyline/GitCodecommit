    ...
    public class Z_Post_Property_By_Loc : System.Web.Services.WebService
    {
        ...
        public string Z_POST_PROPERTY_BY_LOC(string Jsonstring)
        {
            ...
            try
            {
                ...
                SetPropertyValue(smartObject.ListMethods["Z_POST_PROPERTYBY_LOC_Z_POST_PROPERTY_BY_LOC"].InputProperties["p_P_GJAHR"], DateTime.Now.Year.ToString());
                ...
                if (sMessage == "")
                {
                    sMessage = dt_retrun.Rows[0]["O_TABLE_MESSG"].ToString();
                }
        ...
        public string Z_POST_PROPERTY_BY_LOC_I_TABLE(DataTable dt)
        {
            ...
            try
            {
                foreach (DataRow row in dt.Rows)
                {
                    ...
                    SetPropertyValue(smartObject.Methods["SerializeAddItemToArray"].InputProperties["ANLN1"], row["O_TABLE_ANLN1"].ToString());
                    SetPropertyValue(smartObject.Methods["SerializeAddItemToArray"].InputProperties["ANLN2"], row["O_TABLE_ANLN2"].ToString());
                    SetPropertyValue(smartObject.Methods["SerializeAddItemToArray"].InputProperties["WERKS"], row["O_TABLE_WERKS"].ToString());
                    SetPropertyValue(smartObject.Methods["SerializeAddItemToArray"].InputProperties["STORT"], row["O_TABLE_STORT"].ToString());
                    SetPropertyValue(smartObject.Methods["SerializeAddItemToArray"].InputProperties["MENGE"], row["O_TABLE_MENGE"].ToString());
                    SetPropertyValue(smartObject.Methods["SerializeAddItemToArray"].InputProperties["MEINS"], row["O_TABLE_MEINS"].ToString());
                    SetPropertyValue(smartObject.Methods["SerializeAddItemToArray"].InputProperties["PERNR"], row["O_TABLE_PERNR"].ToString());
                    SetPropertyValue(smartObject.Methods["SerializeAddItemToArray"].InputProperties["CPERNR"], row["O_TABLE_CPERNR"].ToString());

                    if (dt.Columns.Contains("O_TABLE_NEWSTORT"))
                        SetPropertyValue(smartObject.Methods["SerializeAddItemToArray"].InputProperties["NEWSTORT"], row["O_TABLE_NEWSTORT"].ToString());

                    SetPropertyValue(smartObject.Methods["SerializeAddItemToArray"].InputProperties["BUKRS"], row["O_TABLE_BUKRS"].ToString());
