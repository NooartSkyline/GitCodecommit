...
namespace DoHome.MobileService
{
    ...
    public class ProductSaleDetail
    {
        ...
        /// <summary>
        /// Gets or sets the LastGrQty
        /// </summary>
        [DataMember]
        [MapValue("LastGrQty")]
        public decimal LastGrQty { get; set; }

        /// <summary>
        /// Gets or sets the LastGrDate
        /// </summary>
        [DataMember]
        [MapValue("LastGrDate")]
        public string LastGrDate { get; set; }

        /// <summary>
        /// Gets or sets the LastSaleQty
        /// </summary>
        [DataMember]
        [MapValue("LastSaleQty")]
        public decimal LastSaleQty { get; set; }

        /// <summary>
        /// Gets or sets the LastSaleDate
        /// </summary>
        [DataMember]
        [MapValue("LastSaleDate")]
