...
namespace DoHome.MobileService
{
    ...
    public partial interface IMobileService
    {
        ...
        [OperationContract]
        List<HandHeldCounterHold> GetHandHeldCounterHoldByToDayAndProductCode(string branchCode, string productCode);
    ...
    public partial class MobileService : IMobileService
    {
        ...
        public List<HandHeldCounterHold> GetHandHeldCounterHoldByToDayAndProductCode(string branchCode, string productCode)
        {
            using (DbManager db = new DbManager(branchCode))
            {
                return db.SetCommand(GetSql(94), db.Parameter("@ProductCode", "%" + productCode + "%")).ExecuteList<HandHeldCounterHold>();
            }
        }
