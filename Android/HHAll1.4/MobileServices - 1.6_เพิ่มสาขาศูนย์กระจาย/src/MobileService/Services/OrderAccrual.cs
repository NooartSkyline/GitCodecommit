...
namespace DoHome.MobileService
{
    ...
    public partial class MobileService : IMobileService
    {
        ...
        {
            //log.Debug("OrderAccrualGetByProductCode start " + DateTime.Now);
            ...
            //log.Debug("OrderAccrualGetByProductCode end " + DateTime.Now);
        ...
        public void OrderAccrualAdd(string productCode, string productName, string unitCode, double quantity, string branchCode, string createdUserCode, string createdUserName)
        {
            ...
            {
                db.SetCommand(GetSql(60),
                db.Parameter("@ID", System.Guid.NewGuid()),
                ...
                db.Parameter("@BARCODE", BarcodeGetByProductCode(branchCode, productCode, unitCode)),
                db.Parameter("@QUANTITY", quantity),
                db.Parameter("@CREATEDATE", DateTime.Now.Date),
                db.Parameter("@CREATETIME", DateTime.Now),
