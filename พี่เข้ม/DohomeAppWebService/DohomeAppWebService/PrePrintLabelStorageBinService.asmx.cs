...
{
    public class PrePrintLabelStorageBinService : System.Web.Services.WebService
    {
        ...
        public string OnSave(string Jsonstring, string sStatus, string sDocNo)
        {
            ...
            try
            {
                ...
                if (ret)
                {
                    ...
                    newrow["docdate"] = dr["DOCDATE"].ToString();
        ...
        [WebMethod]
        public string OnSearchByStatus(string sDocNo, string sUserName, string sStatus)
        {
            DataSet ds = new DataSet();
            DataSet objds = new DataSet();
            try
        ...
        [WebMethod]
        public string OnSearchByArticleName(string sProductName)
        {
            string sResult = "";
